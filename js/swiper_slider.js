...
const swiper = new Swiper('.swiper-container', {
    ...
    navigation: {
        nextEl: '.block-1__arrow-right',
        prevEl: '.block-1__arrow-left',
    },
    loop: true,
    loopedSlides: 1,
});
...
const swiper3 = new Swiper('.swiper-container3', {
    ...
    // setWrapperSize: true,
    navigation: {
        nextEl: '.block-5__arrow-right',
        prevEl: '.block-5__arrow-left',
    },
    pagination: {
        el: '.block-5__arrow-dots',
        clickable: true,
    },
    breakpoints: {
    ...
    on: {
        transitionEnd: function () {
            ...
            for (let i = 0; i < slide_img.length; i++) {
                ...
                slide_img[i].classList.add('swiper-slide-active');
                slide_img[i].style.cursor = 'pointer';
                slide_img[i].addEventListener('click', (el) => {
                    el.preventDefault();
